...
def trackMood():
    ...
    def saveMood():
        ...
        if moodTrack > 5:
            moodLabel.configure(text="That is not on the scale")
        elif moodTrack < 3:
            moodLabel.configure(text="Things will get better")
            goalAchieved = 1
        else:
            moodLabel.configure(text="That's great.")
            goalAchieved = 1
...
def trackFood():
    ...
    def checkListOptions():
        ...
        ctk.CTkLabel(dashboard, text="Food groups logged successfully!", fg_color="green").pack(pady=5)
    ...
    ctk.CTkLabel(dashboard, text="What food groups have you eaten today?").pack(pady=10)
...
def trackSleep():
    ...
    label = ctk.CTkLabel(dashboard, text="How many hours did you sleep last night?", font=("Aptos", 16))
...
def trackExercise():
    ...
    def saveExercise():
        ...
        try:
            ...
            ctk.CTkLabel(dashboard, text="Exercise logged successfully!", fg_color="green").pack(pady=5)
        except Exception as e:
            ctk.CTkLabel(dashboard, text=f"Error: {e}", fg_color="red").pack(pady=5)

    # Prompt user to select exercise type
    ctk.CTkLabel(dashboard, text="Select the type of exercise:", font=("Aptos", 16)).pack(pady=10)
